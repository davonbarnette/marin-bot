...
import {Dropzone, DropzoneProps, DropzoneStatus, MIME_TYPES} from '@mantine/dropzone';
...
export function DropzoneButton({ onDrop }:Props) {
                ...
                {(status:DropzoneStatus) => (
                    <div style={{pointerEvents: 'none'}}>
                        ...
                        <Text align="center" size="sm" mt="xs" color="dimmed">
                            Drag and drop files here to upload. We can accept only <i>.csv</i> files that
